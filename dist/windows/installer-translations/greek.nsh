...
LangString inst_requires_win10 ${LANG_GREEK}  "Αυτός ο εγκαταστάτης απαιτεί τουλάχιστον Windows 10 (1809) ή Windows Server 2019."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qBittorrent"
LangString inst_uninstall_link_description ${LANG_GREEK} "Ξεκατέβασε qBittorrent"
